      ...
      <section id="contact" className="relative isolate overflow-hidden bg-background py-28">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mt-12 flex flex-wrap items-center justify-center gap-6 text-sm text-muted-foreground">
            ...
            <a href="tel:07731552882" className="inline-flex items-center gap-2 transition hover:text-foreground">
              <Phone className="h-4 w-4" /> Book a call
            </a>
            <a href="https://wa.me/447731552882" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 transition hover:text-foreground">
