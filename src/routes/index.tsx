  ...
  return (
    <div className="min-h-screen bg-background font-[Inter,system-ui,sans-serif] text-foreground antialiased">
      ...
      <header className="fixed top-0 z-50 w-full border-b border-white/10 bg-[oklch(0.13_0.03_255/0.7)] backdrop-blur-xl">
        <div className="mx-auto flex h-[120px] max-w-7xl items-center justify-between px-6">
        ...
        <div className="mx-auto max-w-5xl px-6">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[oklch(0.2_0.07_252)] via-[oklch(0.3_0.12_245)] to-[oklch(0.55_0.18_230)] p-12 text-white shadow-[var(--shadow-elegant)] md:p-16">
            ...
            <div className="relative">
              <h2 className="font-[Space_Grotesk] text-4xl font-bold tracking-tight md:text-5xl lg:text-6xl">
                Let's talk about your technology.
              </h2>
              <p className="mt-4 max-w-2xl text-xl text-white/80 md:text-2xl">
                Free, no-obligation consultation. Tell us what's working — and what isn't — and we'll suggest the right next step.
              </p>
            </div>
          </div>

          <div className="mt-12 flex flex-wrap items-center justify-center gap-6 text-base text-foreground md:text-lg">
            <a href="mailto:info@iperial.com" className="inline-flex items-center gap-2 transition hover:text-[oklch(0.55_0.18_230)]">
              <Mail className="h-5 w-5" /> info@iperial.com
            </a>
            <a href="tel:07731552882" className="inline-flex items-center gap-2 transition hover:text-[oklch(0.55_0.18_230)]">
              <Phone className="h-5 w-5" /> Book a call
            </a>
            <a href="https://wa.me/447731552882" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 transition hover:text-[oklch(0.55_0.18_230)]">
